...
const DefaultConfirmBodyHTML = `<hr>` +
	...
	`<td style="padding-left:8px"><p>We will review your resume and any other documents you&#39;ve provided</p></td>` +
	`</tr>` +
	`<tr>` +
	`<td align="center" style="padding-left:8px;width:20px;vertical-align:top">&bull;</td>` +
	`<td style="padding-left:8px"><p>You&#39;ll hear back from us in the coming days</p></td>` +
	`</tr>` +
	`</table>` +
	...
	`class="sd-theme-button">View other job postings</a>` +
	`<hr>`
...
const DefaultDeclineBodyHTML = `<hr>` +
	...
	`<a href="$.career_site_homepage_href$" ` +
	`style="background-color:#3b82f6;color:#ffffff;font-weight:700;padding:8px 16px;border-radius:0.25rem;text-decoration:none;display:inline-block;margin-bottom:20px" ` +
	`class="sd-theme-button">View Job Postings</a>`
